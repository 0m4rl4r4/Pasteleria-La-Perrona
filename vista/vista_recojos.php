...
<html lang="es">
  <head>
      <title>Entregas | Pasteleria</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    <div class="container">
        ...
        <h3 style="text-align: center;margin-top: 30px;margin-bottom: 30px;color: #5F4C0B" >ENTREGAS EN TIENDA </h3>
        <div class="row">
            <div class="col-6">
                <a href="../controlador/controlador_recojo.php?opcion=10" target="_blank"><button class="btn btn-info sm" >Nueva entrega</button></a>
